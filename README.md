...
- Stesso **App ID Agora** e stessa **chiave di casa** su visore e telecamere (progetto Testing senza token). Canale fisso `casa_sicura`. Video, audio e comandi sono cifrati con AES-256-GCM2 di Agora.
...
2. Installa l’APK locale **`home-security-cam-1.0.1+23-local.apk`** su visore e telecamere.
3. Incolla **lo stesso App ID** e **la stessa chiave di casa** (almeno 8 caratteri) su tutti i dispositivi. Il link Agora nella schermata iniziale apre il browser predefinito.
...
L’APK da usare è **`home-security-cam-1.0.1+23-local.apk`**. Chiave di casa: 8–62 caratteri, identica su telefoni e visore PC **19g**. Non usare v1.0.0 né v1.0.1. Per il kiosk vedi [device-owner/README.md](device-owner/README.md). Manuale: [docs/Manuale_uso_Casa_Sicura.pdf](docs/Manuale_uso_Casa_Sicura.pdf).
