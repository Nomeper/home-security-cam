...
- **Branch:** main
- **Working tree:** Release v1.0.1 pubblicata
...
- GitHub Release **v1.0.1**: https://github.com/Nomeper/home-security-cam/releases/tag/v1.0.1
- APK `home-security-cam-1.0.1.apk` (253.4 MB) allegato. SHA-256 hex `9156159d4b7823056afc7816705790dc8bf1904d0f2040f5baae35e2cca6a4cf`, Base64 URL-safe `kVYVnUt4IwVq_HgWcFeQ3IvxkE0PIED1uq414sympM8`.
- QR Device Owner in `device-owner/provisioning-qr.png` (non usare v1.0.0).

## In corso

- Test utente: visore sul telefono quotidiano, telecamera via QR su device dedicato.
...
1. Creare progetto Agora gratis (Testing, senza token) e copiare l’App ID sui due telefoni.
2. Visore: installare l’APK v1.0.1 dal link della Release.
3. Telecamera: factory reset e QR `device-owner/provisioning-qr.png`.
